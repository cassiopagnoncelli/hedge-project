...
extern int      MM_media_Diretor      = 15;
extern int      MM_rapida_Diretor     = 5;
...
int start()
{
  ...
  double
    ...
    diretor_media_0  = iMA(Symbol(),time_frame_diretor, MM_media_Diretor,  0, MODE_SMA, PRICE_CLOSE, 0),
    diretor_media_1  = iMA(Symbol(),time_frame_diretor, MM_media_Diretor,  0, MODE_SMA, PRICE_CLOSE, 1),
  ...
  if (time_frame_diretor != 0) {
    ...
    if (diretor_lenta_0 < diretor_media_0 && diretor_media_0 < diretor_rapida_0
          && diretor_lenta_1 < diretor_media_1 && diretor_media_1 > diretor_rapida_1)
    ...
    if (tendencia_diretor == DIRETOR_ALTA
        && (diretor_rapida_0 < diretor_media_0 || diretor_media_0 < diretor_lenta_0))
      tendencia_diretor = DIRETOR_NOP;
    
    // perda de tendência de baixa
    if (tendencia_diretor == DIRETOR_BAIXA
        && (diretor_rapida_0 > diretor_media_0 || diretor_media_0 > diretor_lenta_0))
      tendencia_diretor = DIRETOR_NOP;
  }
    ...
    (Aplicar_Filtro_de_Horario && Filtro_Horario(Horario_Inicio, Horario_Fim)))
  {
    if (!trava_trade && trava_tempo != Time[0] && trava_tempo != Time[1]) {
      ...
      if (time_frame_diretor == 0
          || (time_frame_diretor != 0 && tendencia_diretor == DIRETOR_ALTA)) {
      ...
      if (time_frame_diretor == 0
           || (time_frame_diretor != 0 && tendencia_diretor == DIRETOR_BAIXA)) {
        if (media_0 < lenta_0 && rapida_0 < lenta_0 && media_1 < lenta_1 && rapida_1 < lenta_1) {
          // Cruzamento das médias móveis rápida e média
...
bool AcompanhaPosicaoIndividualSL3TP(int num_ticket)
{
  ...
  case OP_BUY:
    ...
    if (time_frame_diretor != 0
        && !(diretor_lenta_0 < diretor_media_0 && diretor_media_0 < diretor_rapida_0))
      return (EncerraPosicaoTotal());
    else {
