...
void tela() {
   ...
   str = StringConcatenate(str, "uptime: ", StringConcatenate((TimeCurrent() - data_inicio)/(PERIOD_D1*60), " dias"));
   
   Comment(str, "\n",
           "liq: ", AccountEquity(), "  ", "liq/bal: ", AccountEquity()/AccountBalance(), "\n",
           "margin: ", AccountMargin(), "  ", "free margin: ", AccountFreeMargin(), "  ",
           "equity: ", AccountEquity(), "  ", "balance: ", AccountBalance(), "  ",
           "(lev=", AccountLeverage(),",", "stopout-level=", AccountStopoutLevel(), ")");
}
