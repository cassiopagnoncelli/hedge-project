...
extern string  str_3_1        = "trailing start (pips)";
extern int     trailing_st    = 6;
...
void monitor()
{
   ...
   if(AccountStopoutMode()==0)
      stopout_l = StringConcatenate("stopout=", AccountStopoutLevel(), "%");
   else
      stopout_l = StringConcatenate("stopout=", AccountStopoutLevel(), " ", AccountCurrency());
