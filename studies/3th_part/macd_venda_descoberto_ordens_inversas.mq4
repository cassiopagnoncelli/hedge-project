...
extern int       MACD_EMM_FAST = 21;
extern int       MACD_SMA      = 1;
extern double    LOT_SIZE      = 0.2;
extern int       STOP_LOSS     = 80;
extern int       TAKE_PROFIT   = 170;

double    PIP           = 0.0001;
double    MACD_lim_sup = 0.0018,
          MACD_lim_inf = 0.0014,
...
int start() {
     ...
     OrderSend(Symbol(), OP_BUY, LOT_SIZE, Ask, 0, Ask - STOP_LOSS*PIP, Ask + TAKE_PROFIT*PIP);
